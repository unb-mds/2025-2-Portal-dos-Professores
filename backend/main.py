...
def search_professors(
    q: Optional[str] = Query(None, alias="q", description="Busca por parte do nome do professor (case-insensitive)"),
    ...
    if q:
        results = [p for p in results if p.get('nome') and q.lower() in p.get('nome').lower()]
